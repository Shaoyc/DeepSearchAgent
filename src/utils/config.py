...
class Config:
    ...
    # 模型配置
    default_llm_provider: str = "deepseek"  # 支持: deepseek, openai, glm
    deepseek_model: str = "deepseek-chat"
    openai_model: str = "gpt-4o-mini"
    glm_model: str = "glm-flash-4v"  # ← 新增默认值
    ...
    def validate(self) -> bool:
        ...
        if provider == "glm" and not self.glm_api_key:
            print("错误: GLM API Key未设置")
            return False
    ...
    def from_file(cls, config_file: str) -> "Config":
        ...
        if config_file.endswith('.py'):
            ...
            return cls(
                ...
                glm_api_key=getattr(config_module, "GLM_API_KEY", None),      # ← 新增
                glm_model=getattr(config_module, "GLM_MODEL", "glm-flash-4v"), # ← 新增
            ...
            return cls(
                ...
                glm_api_key=config_dict.get("GLM_API_KEY"),  # ← 新增
                glm_model=config_dict.get("GLM_MODEL", "glm-flash-4v"),  # ← 新增
...
def print_config(config: Config):
    ...
    print(f"GLM模型: {config.glm_model}")  # ← 新增显示
    ...
    print(f"GLM API Key: {'已设置' if config.glm_api_key else '未设置'}")  # ← 新增
